...
import { AsyncStorage, StatusBar, StyleSheet, Text, View, ScrollView, TouchableOpacity, KeyboardAvoidingView } from 'react-native';
...
class Profile extends Component {
  ...
  async onConfirmSubmitted(token) {
      try {
          ...
          this.setState({ success: "Successfully confirmed email address.", error: null, loading: false, modalShowing: false });
          ...
          <KeyboardAvoidingView behavior="height">
            <ScrollView>
              <View style={styles.signUpForm}>
                <View style={styles.formContainer}>
                    <IconTextInput {...settings.usernameInput} editable={false} selectTextOnFocus={false} iconColor={'#888888'} />
                    ...
                    {!!this.state.isNurseFlag === '1' &&
                      <View>
                        ...
                        <IconTextInput {...settings.vanityPhoneInput} editable={false} selectTextOnFocus={false} iconColor={'#888888'} />
            ...
            <View style={styles.buttonsContainer}>
              <TouchableOpacity onPress={() => this.update()}>
                <Text style={settings.submitButtonInverse}>{ 'Update'.toUpperCase() }</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => this.logout()}>
                <Text style={settings.submitButtonInverse}>{ 'Logout'.toUpperCase() }</Text>
              </TouchableOpacity>
            </View>
